...
public class D3TwoCube extends SequentialCommandGroup {
    public D3TwoCube(Swerve s_Swerve,ArmSubsystem armSubsystem,WristSubsystem wristSubsystem, CollectionSubsystem collectionSubsystem, Vision limelightSubsystem){

// This will load the file "FullAuto.path" and generate it with a max velocity of 4 m/s and a max acceleration of 3 m/s^2
// for every path in the group
ArrayList<PathPlannerTrajectory> pathGroup = (ArrayList<PathPlannerTrajectory>) PathPlanner.loadPathGroup("D3TwoCube",
...
eventMap.put("RejectRun2", collectionSubsystem.setVoltage(-1f).andThen(new WaitCommand(1).andThen(collectionSubsystem.stopMotor())));
