...
public class D2ConeCubeE extends SequentialCommandGroup {
    public D2ConeCubeE(Swerve s_Swerve,ArmSubsystem armSubsystem,WristSubsystem wristSubsystem, CollectionSubsystem collectionSubsystem,FixOrientation level){

// This will load the file "FullAuto.path" and generate it with a max velocity of 4 m/s and a max acceleration of 3 m/s^2
// for every path in the group
ArrayList<PathPlannerTrajectory> pathGroup = (ArrayList<PathPlannerTrajectory>) PathPlanner.loadPathGroup("D2ConeCubeE",
...
eventMap.put("Level", level.andThen(collectionSubsystem.shootCube()));
