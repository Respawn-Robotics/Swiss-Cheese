...
public class ThreePiece extends SequentialCommandGroup {
    public ThreePiece(Swerve s_Swerve, ArmSubsystem armSubsystem, WristSubsystem wristSubsystem, CollectionSubsystem collectionSubsystem, Vision limelightSubsystem){
        ...
        eventMap.put("groud2", armSubsystem.setPosition(15000).andThen(wristSubsystem.setPosition(60000).alongWith(collectionSubsystem.collectCube().andThen(new WaitCommand(.5).andThen(armSubsystem.setPosition(15000))))));
        eventMap.put("home4", armSubsystem.setPosition(0).andThen(wristSubsystem.setPosition(0)).andThen(collectionSubsystem.stopMotor()));
