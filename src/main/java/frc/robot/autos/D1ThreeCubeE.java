...
public class D1ThreeCubeE extends SequentialCommandGroup {
    public D1ThreeCubeE(Swerve s_Swerve,ArmSubsystem armSubsystem,WristSubsystem wristSubsystem, CollectionSubsystem collectionSubsystem, Vision limelightSubsystem, FixOrientation level){
