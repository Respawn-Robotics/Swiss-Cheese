...
public class D1TwoCubeE extends SequentialCommandGroup {
    public D1TwoCubeE(Swerve s_Swerve,ArmSubsystem armSubsystem,WristSubsystem wristSubsystem, CollectionSubsystem collectionSubsystem, Vision limelightSubsystem, FixOrientation level){

// This will load the file "FullAuto.path" and generate it with a max velocity of 4 m/s and a max acceleration of 3 m/s^2
// for every path in the group
ArrayList<PathPlannerTrajectory> pathGroup = (ArrayList<PathPlannerTrajectory>) PathPlanner.loadPathGroup("D1TwoCubeE",
...
eventMap.put("RejectRun", collectionSubsystem.setVoltage(-1f));
eventMap.put("ArmGoOut", armSubsystem.setPosition(Constants.ArmConstants.ACQUIRE_FROM_CUBE_FLOOR).alongWith(wristSubsystem.setPosition(Constants.WristConstants.ACQUIRE_FROM_CUBE_FLOOR - 2000).alongWith(collectionSubsystem.collectCube())));
...
eventMap.put("RejectRun2", collectionSubsystem.setVoltage(-.8f));
