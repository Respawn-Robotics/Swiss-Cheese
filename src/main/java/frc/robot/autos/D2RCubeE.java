...
public class D2RCubeE extends SequentialCommandGroup {
    public D2RCubeE(Swerve s_Swerve,ArmSubsystem armSubsystem,WristSubsystem wristSubsystem, CollectionSubsystem collectionSubsystem, Vision limelightSubsystem,FixOrientation level){
