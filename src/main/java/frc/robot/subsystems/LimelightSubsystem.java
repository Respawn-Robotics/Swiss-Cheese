...
public class LimelightSubsystem extends SubsystemBase {
    ...
    public static class LimelightConstants {
        ...
        public edu.wpi.first.math.geometry.Pose2d kTurretToLens = Pose2d.identity();
        public edu.wpi.first.math.geometry.Rotation2d kHorizontalPlaneToLens = Rotation2d.identity();
    }

    private NetworkTable mNetworkTable;

    public LimelightSubsystem(LimelightConstants constants) {
    ...
    public edu.wpi.first.math.geometry.Pose2d getTurretToLens() {
    ...
    public edu.wpi.first.math.geometry.Rotation2d getHorizontalPlaneToLens() {
